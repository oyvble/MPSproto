#' @title inferStuttRegModel 
#' @description A function to perform beta-regression analysis 
#' @details The data table can be stutterdata table obtained from the obtainStutterData function
#' @param stutterData Datatable with columns ("Locus","Type","BLMM","Prop.)
#' @param minStuttOccurence The number of required observations in order to fit a linear regression with BLMM 
...
inferStuttRegModel = function(stutterData, minStuttOccurence=10,print2pdf=NULL,signifLevel=0.05,addValid=FALSE,modPrec=FALSE) {
...
#  type=types[1]
      ...
      if(nrow(sub2) < minStuttOccurence ) next #skip
